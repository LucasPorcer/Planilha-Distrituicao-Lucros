...
const ACCEPT = ".pdf,.png,.jpg,.jpeg,.webp,.xlsx";
...
export default function FileUploader({
  ...
  function handleFile(file: File) {
    ...
    if (!isValidType) {
      setError("Formato não suportado. Use PDF, Excel (.xlsx), PNG, JPG ou WebP.");
      return;
    }
            ...
            <div className="flex items-center gap-4">
              <motion.div
                ...
                style={{
                  ...
                  border: `1px solid ${isPdf ? "rgba(239,68,68,0.2)" : isXlsx ? "rgba(16,185,129,0.2)" : "rgba(129,140,248,0.2)"}`,
                }}
              ...
              <div className="flex items-center gap-4">
                ...
                <div className="flex-1">
                  ...
                  <p className="text-xs text-slate-500 mt-0.5">
                    PDF, Excel, PNG, JPG ou WebP — max. 20MB
                  </p>
                </div>
